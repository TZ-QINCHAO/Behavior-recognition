...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/root/autodl-fs/ultralytics-main/ultralytics/cfg/models/v8/yolov8n-repvitm1_5-bifpn-c2f_EIEM-dyHead.yaml', help='trained weights path')
